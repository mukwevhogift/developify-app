...
export const properties: Property[] = [
  ...
  },
  {
    ...
    targetAmount: 57600000,
    currentAmount: 32400000,
    roi: 15.1,
  ...
  },
  {
    ...
    targetAmount: 39600000,
    currentAmount: 39600000,
    roi: 7.5,
...
export const investments: Investment[] = [
  { id: 'inv-1', propertyId: '2', amount: 450000, date: '2023-10-15', status: 'Completed' },
  { id: 'inv-2', propertyId: '1', amount: 900000, date: '2024-01-20', status: 'Active' },
  { id: 'inv-3', propertyId: '4', amount: 1800000, date: '2024-03-05', status: 'Active' },
  { id: 'inv-4', propertyId: '6', amount: 1350000, date: '2023-08-11', status: 'Completed' },
];
...
export const transactions: Transaction[] = [
  { id: 'txn-1', type: 'Deposit', amount: 1800000, date: '2024-01-10', status: 'Completed', description: 'Bank Transfer' },
  { id: 'txn-2', type: 'Investment', amount: -900000, date: '2024-01-20', status: 'Completed', description: 'Azure Heights Villa' },
  { id: 'txn-3', type: 'Investment', amount: -1800000, date: '2024-03-05', status: 'Completed', description: 'The Onyx Penthouse' },
  { id: 'txn-4', type: 'Withdrawal', amount: -180000, date: '2024-04-01', status: 'Pending', description: 'To linked bank account' },
  { id: 'txn-5', type: 'Deposit', amount: 360000, date: '2024-04-15', status: 'Completed', description: 'Bank Transfer' },
  { id: 'txn-6', type: 'Dividend', amount: 22500, date: '2024-05-01', status: 'Completed', description: 'From Metropolis Tower' },
];
...
export const notifications: Notification[] = [
    { id: 'notif-1', title: 'Investment Successful', description: 'Your R900,000 investment in Azure Heights Villa is confirmed.', date: '2024-01-20', read: true },
    { id: 'notif-2', title: 'Withdrawal Pending', description: 'Your withdrawal request of R180,000 is being processed.', date: '2024-04-01', read: false },
    { id: 'notif-3', title: 'Funds Added', description: 'You have successfully deposited R360,000 to your wallet.', date: '2024-04-15', read: false },
    { id: 'notif-4', title: 'Dividend Received', description: 'You received a R22,500 dividend from Metropolis Tower.', date: '2024-05-01', read: false },
];
